...
def get_localization_id(version_id):
    ...
    payload = api("POST", "/appStoreVersionLocalizations", json={
        "data": {
            ...
            "attributes": {
                "locale": "ja",
                "description": "今いる場所の天気・地震・ニュース・電車運行・近くのお店・イベント・桜情報を一画面にまとめて表示。位置情報だけで、あなたの「近所」がわかるアプリ。",
                "keywords": "近所,天気,地震,ニュース,電車,運行情報,イベント,桜,位置情報,地域",
                "marketingUrl": "https://snarfnet.github.io/",
                "supportUrl": "https://snarfnet.github.io/",
                "whatsNew": "UIの改善とパフォーマンス向上",
            },
